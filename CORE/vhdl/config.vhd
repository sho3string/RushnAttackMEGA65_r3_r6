...
-- Dipswitch C
constant OPTM_G_SEGAWB_DSWC4      : integer := 22;
constant OPTM_G_SEGAWB_DSWC5      : integer := 23;
constant OPTM_G_SEGAWB_DSWC6      : integer := 24;
constant OPTM_G_SEGAWB_DSWC7      : integer := 25; 

constant OPTM_G_FLIPJ             : integer := 26;
constant OPTM_G_VGA_MODES         : integer := 27;
constant OPTM_G_SEGAWB_H1         : integer := 28;        
constant OPTM_G_SEGAWB_H2         : integer := 29;    
constant OPTM_G_SEGAWB_H4         : integer := 30;    
constant OPTM_G_SEGAWB_H8         : integer := 31;    
constant OPTM_G_SEGAWB_H16        : integer := 32;
constant OPTM_G_SEGAWB_V2         : integer := 33;        
constant OPTM_G_SEGAWB_V4         : integer := 34;    
constant OPTM_G_SEGAWB_V8         : integer := 35;
constant OPTM_G_SEGAWB_V16        : integer := 36;   
...
constant OPTM_GROUPS       : OPTM_GTYPE := ( OPTM_G_TEXT + OPTM_G_HEADLINE,                             -- Headline "Demo Headline A"
                                             ...
                                             OPTM_G_SEGAWB_v8  + OPTM_G_SINGLESEL,
                                             OPTM_G_SEGAWB_v16 + OPTM_G_SINGLESEL,  
                                             OPTM_G_LINE,                                               -- Line
                                             OPTM_G_CLOSE + OPTM_G_SUBMENU,                             -- Close submenu / back to main menu
                                             OPTM_G_LINE,                                               -- Line
                                             ...
                                             OPTM_G_SEGAWB_DSWB2  + OPTM_G_SINGLESEL + OPTM_G_STDSEL,                   
                                             OPTM_G_SEGAWB_DSWB3  + OPTM_G_SINGLESEL,                   
                                             OPTM_G_SEGAWB_DSWB4  + OPTM_G_SINGLESEL + OPTM_G_STDSEL,   
                                             OPTM_G_SEGAWB_DSWB5  + OPTM_G_SINGLESEL + OPTM_G_STDSEL,                    
                                             OPTM_G_SEGAWB_DSWB6  + OPTM_G_SINGLESEL,                   
                                             OPTM_G_SEGAWB_DSWB7  + OPTM_G_SINGLESEL + OPTM_G_STDSEL,                  
                                             OPTM_G_SEGAWB_DSWC4  + OPTM_G_SINGLESEL,   
                                             OPTM_G_SEGAWB_DSWC5  + OPTM_G_SINGLESEL,   
                                             OPTM_G_SEGAWB_DSWC6  + OPTM_G_SINGLESEL,                   
                                             OPTM_G_SEGAWB_DSWC7  + OPTM_G_SINGLESEL,                   
                                             OPTM_G_LINE,                
                                             OPTM_G_CLOSE + OPTM_G_SUBMENU,                             -- Close submenu / back to main menu
                                             OPTM_G_LINE,                                               -- Line
